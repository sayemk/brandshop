			...
			<div class="col-lg-6 col-md-6 single_product_details">
				...
				<div class="single_product_description">
					  ...
					  <?php 
							...
							echo form_open('cart/added/', $attr); 
						?>
					  <div class="form-group">
					    ...
					    <div class="col-sm-10" >
					      <select class="form-control" name="p_color">
							  ...
							  <?php 
							  	foreach (explode(',', $product[0]->p_color ) as $value) {
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					       <select class="form-control" name="p_dimension" >
							  <?php 
							  	foreach (explode(',', $product[0]->p_dimension ) as $value) {
							  		 echo "<option value='$value'>$value</option>";
							  	}
							  ?>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
							...
							<input class="form-control" type="text" name="unit_price" id="unit_price" value="<?php echo $product[0]->price;?>" placeholder="" readonly>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
					       <div class="quantity" >
								...
								<input class="input-text qty text" type="number" size="10" title="Qty" value="1" id="quantity"name="quantity" min="1" step="1">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10">
							...
							<input id="total_price" name="total_price" value="<?php echo $product[0]->price;?>" class="form-control" type="text" placeholder="" readonly>
											...
											<div class="comment-respond" id="respond">
												...
												?>
													...
													<p class="comment-form-comment">
														<input type="hidden" name="p_id" value="<?php echo $product[0]->p_id; ?>"/>
														<textarea value="<?php echo set_value('email'); ?>" required name="comment" id="comment" placeholder="Your Review"></textarea>
